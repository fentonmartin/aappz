package io.github.fentonmartin.aappz.location.util;
...
import io.github.fentonmartin.aappz.location.listener.StoreListener;

public class ActivityStore implements StoreListener<DetectedActivity> {
