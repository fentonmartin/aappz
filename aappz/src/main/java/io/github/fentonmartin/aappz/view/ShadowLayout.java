package io.github.fentonmartin.aappz.view;
...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleRes) {
        ...
        try {
            ...
            shadowColor = attr.getColor(R.styleable.ShadowLayout_shadowColor, getResources().getColor(R.color.defaultShadowColor));
        } finally {
            attr.recycle();
        }
    }
